...
var OrderToProduct_1 = __importDefault(require("./OrderToProduct"));
...
var Product = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.ManyToOne(function (type) { return StorageAddress_1.default; }),
        __metadata("design:type", StorageAddress_1.default)
    ], Product.prototype, "stored_in", void 0);
    __decorate([
        typeorm_1.OneToMany(function (type) { return OrderToProduct_1.default; }, function (order) { return order.products; }),
        __metadata("design:type", Array)
